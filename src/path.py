...
class Path(path_pb2_grpc.PathServicer):
    ...
    FILE_NAME = os.path.join(base_dir, '..', 'data', 'SORInfo.txt')
    ...
    def get_valid_next_address(self, client_ip):
        # 获取所有可用SOR节点信息
        sorWeight = load_sorWeight(self.FILE_NAME)
    ...
    def Greet(self, request, context):
        ...
        if new_current_hop < 3:
            with grpc.insecure_channel(next_address+'50051') as channel:
